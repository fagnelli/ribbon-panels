...
ofilename='ribbon_cell_3d-surf.json'
...
cross1=symmetry3d(cross0, (0.5,0., 0), (0.5,1., 0))
cross2=symmetry3d(cross1, (0.,0.5, 0), (1.,0.5, 0))
cross3=symmetry3d(cross0, (0.,0.5, 0), (1.,0.5, 0))
cell0.add(cross0)
cell0.add(cross1)
cell0.add(cross2)
cell0.add(cross3)
...
if out:
    ...
    exchange.export_obj(cell0,"../figures/ribbon_cell_3d-surf.obj")
